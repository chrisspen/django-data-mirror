...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSourceFile.downloaded'
        db.add_column(u'django_data_mirror_datasourcefile', 'downloaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSourceFile.downloaded'
        db.delete_column(u'django_data_mirror_datasourcefile', 'downloaded')
